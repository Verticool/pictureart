  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      if (this.classList.contains('active-style')) {
        this.nextElementSibling.style.maxHeight = this.nextElementSibling.scrollHeight + 75 + 'px';
      } else {
...
var checkTextInputsjsjs = function checkTextInputsjsjs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkTextInputsjsjs);
...
var drop = function drop() {
  ...
  function highlight(item) {
    ...
    item.closest('.file_upload').style.padding = '2px'; // item.closest('.file_upload').style.backgroundColor = 'rgba (0, 0, 0, .7)';
  }

  function unhighlight(item) {
    item.closest('.file_upload').style.border = 'none'; // item.closest('.file_upload').style.backgroundColor = '#ededed';
  }
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var name = arr[0].substring(0, 10) + dots + arr[1];
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // checkNumInputs('input[name="user-phone"]');
...
var scrolling = function scrolling(upSelector) {
  ...
  }); // Scroll with request animation frame
